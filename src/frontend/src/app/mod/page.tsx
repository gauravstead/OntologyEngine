export default function ModDashboard() {
    return (
        <div className="flex flex-col h-full space-y-6">
            <header className="flex items-center justify-between pb-4 border-b border-red-900">
                <h1 className="text-3xl font-light tracking-tight text-white flex items-center">
                    ...
                    Ministry of <span className="font-semibold text-red-100 ml-2">Defence</span>
                </h1>
            ...
            <div className="flex-1 bg-slate-900 border border-slate-800 rounded-lgflex items-center justify-center text-slate-500 font-mono text-sm p-4 text-center">
                [MoD Dashboard Loaded] <br />
                Visualizing tactical deployments, strategic assets, and structural conflict thresholds.
            </div>
        </div>
    );
}
